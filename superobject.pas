...
function SOFindField(jso: ISuperObject; w:string): ISuperObject;
function ParseSeparator(str:String):String;
...
var
  ...
  dt2: Extended;
begin
  dt2 := 25569 + (dt / 86400000);
  DateTimeToSystemTime(dt2, t);
